...
area_model_detail = json.dumps({
    ...
    "fields": [
        ...
        {"fieldName": "sfmj", "dataType": "Numeric"},
        {"fieldName": "zdmj", "dataType": "Numeric"},
        {"fieldName": "gnzt", "dataType": "Varchar"},
...
time_model_detail = json.dumps({
    ...
    "fields": [
        ...
        {"fieldName": "cnq_year", "dataType": "Integer"},
        {"fieldName": "cnq_month", "dataType": "Integer"},
        {"fieldName": "is_payment_season", "dataType": "Smallint"}
    ],
    "sqlVariables": []
}, ensure_ascii=False)
...
charge_model_detail = json.dumps({
    ...
    "fields": [
        ...
        {"fieldName": "djlb", "dataType": "Varchar"},
        {"fieldName": "event", "dataType": "Varchar"},
        {"fieldName": "ysje", "dataType": "Numeric"},
        {"fieldName": "jcys", "dataType": "Numeric"},
        {"fieldName": "qfje", "dataType": "Numeric"},
        {"fieldName": "hjje", "dataType": "Numeric"},
        {"fieldName": "zkje", "dataType": "Numeric"},
        {"fieldName": "wyje", "dataType": "Numeric"}
    ],
    "sqlVariables": []
}, ensure_ascii=False)
...
payment_model_detail = json.dumps({
    ...
    "fields": [
        {"fieldName": "sfrq", "dataType": "Timestamp"},
        {"fieldName": "sffs", "dataType": "Varchar"},
        {"fieldName": "zfqd", "dataType": "Varchar"},
        {"fieldName": "fplb", "dataType": "Varchar"},
        {"fieldName": "sfje", "dataType": "Numeric"}
    ],
    "sqlVariables": []
}, ensure_ascii=False)
...
stop_restart_model_detail = json.dumps({
    ...
    "measures": [],
    "fields": [
        {"fieldName": "ywlx", "dataType": "Varchar"},
        {"fieldName": "sqrq", "dataType": "Date"},
        {"fieldName": "lx", "dataType": "Varchar"},
        {"fieldName": "org_level1", "dataType": "Varchar"}
    ],
    "sqlVariables": []
}, ensure_ascii=False)
...
cnq_charge_model_detail = json.dumps({
    ...
    "fields": [
        ...
        {"fieldName": "arrears_level", "dataType": "Varchar"},
        {"fieldName": "customer_cnt", "dataType": "Bigint"},
        {"fieldName": "sfmj_sum", "dataType": "Numeric"},
        {"fieldName": "ysje_sum", "dataType": "Numeric"},
        {"fieldName": "sfje_sum", "dataType": "Numeric"}
    ],
    "sqlVariables": []
}, ensure_ascii=False)
...
print("清理:", result.stdout, result.stderr)
...
print("主题域:", result.stdout, result.stderr)
...
print("模型:", result.stdout, result.stderr)
...
print("数据集:", result.stdout, result.stderr)
